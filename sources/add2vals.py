...
if argnumbers == 2:
    ...
    print("")
    print("The result is " + str(calc.sub3(str(sys.argv[1]), str(sys.argv[2]), str(sys.argv[3]))))
    print("")
    sys.exit(0)

elif argnumbers != 2 and argnumbers != 3:
    print("")
    print("You entered " + str(argnumbers) + " value/s.")
    print("")
    print("Usage: 'add2vals X Y (and/or Z)' where X and Y (and/or Z) are individual values.")
