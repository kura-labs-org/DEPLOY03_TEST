...
if argnumbers == 3 :
    print("")
    print("The result is " + str(calc.subtract(str(sys.argv[1]), str(sys.argv[2]), str(sys.argv[3]))))
    print("")
    sys.exit(0)
    ...
    print("")
    print("Usage: 'add2vals X Y' where X and Y are individual values. or 'subtract3vals' XYZ where xyz are individual values.")
