...
if argnumbers != 2 or argnumbers != 3:
    print("")
    print("You entered " + str(argnumbers) + " value/s.")
    print("")
    print("Usage: 'multiply3vals X Y Z' where X and Y and Z are individual values.")
    print("       If multiply3vals is not in your path, usage is './multiplyvals X Y Z'.")
    print("       If unbundled, usage is 'python multiply3vals.py X Y Z'.")
    print("")
    sys.exit(2)
