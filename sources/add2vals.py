...
if argnumbers == 3 :
    print("")
    print("The result is " + str(calc.add2(str(sys.argv[1]), str(sys.argv[2]), str(sys.argv[1]))))
    print("The result is " + str(calc.subtract2(str(sys.argv[1]), str(sys.argv[2]), str(sys.argv[1]))))
    print("")
    sys.exit(0)
