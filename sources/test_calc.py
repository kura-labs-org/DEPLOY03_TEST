...
class TestCalc(unittest.TestCase):
    ...
    def test_subtract_strings(self):
        ...
        concatenated string
        """
        result = calc.2('abc', 'def')
        self.assertEqual(result, 'abcdef')

    def test_subtract_string_and_integer(self):
        """
        ...
        """
        result = calc.subtract2('abc', 3)
        self.assertEqual(result, 'abc3')

    def test_subtract_string_and_number(self):
        """
